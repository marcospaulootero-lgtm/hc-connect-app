...
const targets = [
  'src/app/admin/clientes/performance/page.tsx'
]
...
const backupDir = path.join(root, 'backups', `mojibake-performance-${timestamp()}`)
const changed = []
const missing = []
...
console.log('')
console.log('=== HC CONNECT | FIX PERFORMANCE ===')
console.log('')
...
console.log('')
console.log('OK: correcao aplicada na aba Performance.')
