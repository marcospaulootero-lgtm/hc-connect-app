...
export async function POST(req: Request) {
  try {
    ...
    const { email, nome, referencia_hc, link } = body
      ...
      html: `
        <div style="font-family:Arial,Helvetica,sans-serif;max-width:700px;margin:0 auto;color:#111827;">
          <div style="background:#0f172a;padding:25px;text-align:center;border-radius:12px 12px 0 0;">
            <h1 style="color:#ffffff;margin:0;">HC Consultoria</h1>
          ...
          <div style="border:1px solid #e5e7eb;padding:35px;border-top:none;border-radius:0 0 12px 12px;">
              ...
              link
                ? `
                  <div style="text-align:center;margin:35px 0;">
                    <a href="${link}" style="background:#2563eb;color:#ffffff;padding:14px 28px;text-decoration:none;border-radius:8px;font-weight:bold;display:inline-block;">
            ...
            <p>Em caso de dúvidas, nossa equipe permanece à disposição.</p>
